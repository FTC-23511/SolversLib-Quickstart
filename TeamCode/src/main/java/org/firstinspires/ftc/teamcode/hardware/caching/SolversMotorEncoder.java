...
public class SolversMotorEncoder {
    ...
    public SolversMotorEncoder(SolversMotor motor) {
        this.motor = motor;
    ...
    public int getPosition() {
        ...
        int currentPosition = motor.getPosition() * multiplier;
    ...
    /**
     * Uses velocity estimates gathered in {@link #getPosition} to estimate the upper bits of velocity
     * that are lost in overflow due to velocity being transmitted as 16 bits.
     * <p>CAVEAT: must regularly call {@link #getPosition} for the compensation to work correctly.</p>
