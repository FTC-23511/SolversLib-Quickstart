...
//                .build();
    ...
    public void run() {
        ...
        // Sensor 1
        if (ColorSensorsSubsystem.checkIfPurple(hsv1)) {
            color1 = "purple";
        } else if (ColorSensorsSubsystem.checkIfGreen(hsv1)) {
            color1 = "green";
        } else if (ColorSensorsSubsystem.checkIfWhite(hsv1)) {
            color1 = "white";
        }

        // Sensor 2
        if (ColorSensorsSubsystem.checkIfPurple(hsv2)) {
            color2 = "purple";
        } else if (ColorSensorsSubsystem.checkIfGreen(hsv2)) {
            color2 = "green";
        } else if (ColorSensorsSubsystem.checkIfWhite(hsv2)) {
            color2 = "white";
        }
        ...
        telemetry.addData("Sensor 1", color1 + " | raw: " + Arrays.toString(hsv1));
        telemetry.addData("Sensor 2", color2 + " | raw: " + Arrays.toString(hsv2));
