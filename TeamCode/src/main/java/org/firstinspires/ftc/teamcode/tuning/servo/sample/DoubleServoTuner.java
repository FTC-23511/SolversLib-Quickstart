...
//@Config
//@TeleOp
public class DoubleServoTuner extends CommandOpMode {
    ...
    public void run() {
        ...
        if (MOVE_BOTH) {
            robot.leftIntakePivot.set(BOTH_SERVO_POS);
            robot.rightIntakePivot.set(BOTH_SERVO_POS);
        } else {
            robot.leftIntakePivot.set(LEFT_SERVO_POS);
            robot.rightIntakePivot.set(RIGHT_SERVO_POS);
        }
